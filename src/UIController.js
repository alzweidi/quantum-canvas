...
export class UIController {
  ...
  _setupEventListeners() {
    ...
    // Preset buttons
    document
      .getElementById("double-slit-button")
      .addEventListener("click", () => {
        this._applyPreset("DOUBLE_SLIT");
      });
    document
      .getElementById("tunneling-button")
      .addEventListener("click", () => {
    ...
    this._setupSlider(
      "brush-slider",
      "brush-size-value",
      (val) => (this.brushSize = parseInt(val)),
    );
    this._setupSlider(
      "brightness-slider",
      "brightness-value",
    ...
    this._setupSlider(
      "px-slider",
      "px-value",
      (val) => (this.state.params.px = parseInt(val)),
    );
    this._setupSlider(
      "py-slider",
      "py-value",
      (val) => (this.state.params.py = parseInt(val)),
    );
    this._setupSlider(
      "sigma-slider",
      "sigma-value",
      (val) => (this.state.params.sigma = parseInt(val)),
    );
  }
